          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {state?.errors?.password && (
                <div className="mt-2 rounded-md bg-yellow-50 dark:bg-yellow-900/20 p-3">
                  <p className="text-xs font-medium text-yellow-800 dark:text-yellow-400 mb-1">Password must:</p>
                  <ul className="list-disc list-inside space-y-1">
                    {state.errors.password.map((error) => (
                      <li key={error} className="text-xs text-yellow-700 dark:text-yellow-300">{error}</li>
                    ))}
                  </ul>
                </div>
              )}
